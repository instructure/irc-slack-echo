...
var quietTimes = require('./quietTimes');
...
client.addListener('message', function(from, to, message) {
  ...
  // Handle quiet times
  if (quietTimes.isInQuietTimes() && (Date.now() - lastMessageTime > config.quietTimes.idleTime)) {
    client.say(config.irc.channel, quietTimes.getQuietMessage());
  }
